...
from CBAMUSIC.modules.play import generate_cover
from CBAMUSIC.modules.play import arq
from CBAMUSIC.modules.play import cb_admin_check
from CBAMUSIC.modules.play import transcode
from CBAMUSIC.modules.play import convert_seconds
from CBAMUSIC.modules.play import time_to_seconds
from CBAMUSIC.modules.play import changeImageSize
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @CBAMUSIC to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/0acd1f575483e200a6753.jpg"
