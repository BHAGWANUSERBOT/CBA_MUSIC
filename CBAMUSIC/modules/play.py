...
from CBAMUSIC.config import ARQ_API_KEY
from CBAMUSIC.config import BOT_NAME as bn
from CBAMUSIC.config import DURATION_LIMIT
from CBAMUSIC.config import UPDATES_CHANNEL as updateschannel
from CBAMUSIC.config import que
from CBAMUSIC.function.admins import admins as a
from CBAMUSIC.helpers.admins import get_administrators
from CBAMUSIC.helpers.channelmusic import get_chat_id
from CBAMUSIC.helpers.errors import DurationLimitError
from CBAMUSIC.helpers.decorators import errors
from CBAMUSIC.helpers.decorators import authorized_users_only
from CBAMUSIC.helpers.filters import command
from CBAMUSIC.helpers.filters import other_filters
from CBAMUSIC.helpers.gets import get_file_name
from CBAMUSIC.services.callsmusic import callsmusic
from CBAMUSIC.services.callsmusic import client as USER
from CBAMUSIC.services.converter.converter import convert
from CBAMUSIC.services.downloaders import youtube
from CBAMUSIC.services.queues import queues
...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nOr manually add assistant to your Group and try again manually request here @CBA_SUPPORT with your group link</b>",
                    )
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/0acd1f575483e200a6753.jpg"
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @CBA_USERBOT to your Group and try again manually request here @CBA_SUPPORT with your group link</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
        ...
        await lel.edit(
            "<i> helper Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually request here @CBA_SUPPORT with your group link</i>"
        )
        return
